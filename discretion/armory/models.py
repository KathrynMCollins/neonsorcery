...
class ItemType(SearchableCardListMixin, DiscretionModel, metaclass=TransMeta):
...
class Item(HomebrewModel, ModelWithImage, DiscretionModel, metaclass=TransMeta):
...
class WeaponType(SearchableCardListMixin, DiscretionModel, metaclass=TransMeta):
...
class Weapon(HomebrewModel, ModelWithImage, DiscretionModel, metaclass=TransMeta):
...
class WeaponModification(DiscretionModel, metaclass=TransMeta):
...
class RiotGear(HomebrewModel, DiscretionModel, metaclass=TransMeta):
