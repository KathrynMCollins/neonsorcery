...
from discretion.models import ModelWithImage, DiscretionModel, image_upload_path
from worlds.unique_slugify import unique_slugify


@reversion.register
class World(ModelWithImage, DiscretionModel, metaclass=TransMeta):
    INDEX_TEMPLATE_CHOICES = (
        ("index.html", "index.html"),
        ("worlds/world_detail.html", "worlds/world_detail.html"),
    )
    SCSS_FILE_CHOICES = (
        ("theme/discretion.scss", "theme/discretion.scss"),
        ("theme/tirakan.scss", "theme/tirakan.scss"),
        ("theme/neonsorcery.scss", "theme/neonsorcery.scss"),
    )
...
@reversion.register
class WikiPage(ModelWithImage, DiscretionModel, metaclass=TransMeta):
...
@reversion.register
class WikiPageImage(ModelWithImage, DiscretionModel):
    image_upload_to = "wiki_page_images"
...
@reversion.register
class WikiPageGameValues(DiscretionModel):
    wiki_page = models.ForeignKey(
        "worlds.WikiPage",
        verbose_name=_("wiki page"),
...
class WikiPageGameAction(DiscretionModel, metaclass=TransMeta):
    WORK_TYPE_CHOICES = (
        ("lesser", _("Lesser")),
        ("higher", _("Higher")),
    )
...
class WikiPageEmbedding(DiscretionModel):
    wiki_page = models.ForeignKey(
        "worlds.WikiPage",
        verbose_name=_("wiki page"),
...
class Language(HomebrewModel, DiscretionModel, metaclass=TransMeta):
