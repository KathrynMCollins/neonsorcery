...
class EntityCategory(DiscretionModel, metaclass=TransMeta):
...
class Entity(HomebrewModel, ModelWithImage, DiscretionModel, metaclass=TransMeta):
...
class PriestAction(HomebrewModel, DiscretionModel, metaclass=TransMeta):
    WORK_TYPE_CHOICES = (
        ("lesser", _("Lesser")),
        ("higher", _("Higher")),
    )
