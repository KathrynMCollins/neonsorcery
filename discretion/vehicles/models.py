...
class VehicleType(HomebrewModel, DiscretionModel, metaclass=TransMeta):
...
class VehicleMachinery(HomebrewModel, ModelWithImage, DiscretionModel, metaclass=TransMeta):
...
class Vehicle(HomebrewModel, ModelWithImage, DiscretionModel, metaclass=TransMeta):
    """Main vehicle model"""
